...
export interface ProfileValidator {
  ...
  'rangValidator': RangValidatorEnum
}
...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = 'https://gameverify.xyz/api'
  private securityData: SecurityDataType | null = null
  private readonly securityWorker?: ApiConfig<SecurityDataType>['securityWorker']
  private readonly abortControllers = new Map<CancelToken, AbortController>()
  private readonly customFetch = (...fetchParams: Parameters<typeof fetch>) => fetch(...fetchParams)
  ...
  private readonly contentFormatters: Record<ContentType, (input: any) => any> = {
...
export class Api<SecurityDataType> extends HttpClient<SecurityDataType> {
  games = {
    ...
    gameDetail: (params: RequestParams = {}) =>
      this.request<Game[], ErrorResponse>({
        path: '/games/game',
        method: 'GET',
        format: 'json',
